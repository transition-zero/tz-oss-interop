...
START_FUELS_COLLECTION = "Start Fuels"
...
# The collection a Constraint reaches each class of member through, since a Constraint can
# weight an object of any class.
CONSTRAINT_MEMBER_COLLECTIONS = {
    GENERATOR_CLASS: GENERATORS_COLLECTION,
    LINE_CLASS: LINES_COLLECTION,
    NODE_CLASS: NODES_COLLECTION,
    REGION_CLASS: REGIONS_COLLECTION,
    BATTERY_CLASS: BATTERIES_COLLECTION,
    STORAGE_CLASS: STORAGES_COLLECTION,
    FUEL_CLASS: FUELS_COLLECTION,
    EMISSION_CLASS: EMISSIONS_COLLECTION,
}
...
OFFTAKE_AT_START_PROPERTY = "Offtake at Start"
